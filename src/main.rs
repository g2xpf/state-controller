...
use state_controller::{
    primitive_shape::Rectangle, Event, EventHandler, Key, Receiver, Renderable, ShapeContainer,
    Shifter, State, Updatable, World,
};
...
fn main() {
    ...
    let mut rectangle_container = init_state.rectangle_container.clone_context();
    rectangle_container.push(Rectangle {
        pos: [0.0, 0.0],
        width: 0.4,
        height: 0.4,
